...
<body>
  <div class="container">
    <form method="post">
      ...
      <div class="form-group">
        ...
        <input required class="form-control" name="age" id="age">
      </div>
      <div class="form-group">
        <label for="msg">Сообщение</label>
        <textarea required id="msg" class="form-control" name="msg"></textarea>
      </div>
  ...
  <div class="container">
    <p>Привет, <?= $name ?>, <?= $age ?> лет.</p>
    <p>Твое сообщение: <?= $msg ?></p>
  </div>
